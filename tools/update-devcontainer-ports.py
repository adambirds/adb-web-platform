...
def main():
    parser = argparse.ArgumentParser(
        description="Update devcontainer.json ports configuration"
    )
    parser.add_argument(
        "--devcontainer-path",
        required=True,
    ...
    parser.add_argument(
        "--flower-port",
        type=int,
        help="Flower monitoring port (optional)"
    )
