...
import adbsoftwaresolutions.asgi_handler_logging  # noqa: F401
from adbsoftwaresolutions.asgi_middleware import GraphQL400LoggerMiddleware
...
def lazy_setup() -> None:
    ...
    static_root_dev = Path(tempfile.gettempdir()) / "app-dev-static"
